...
// Import the options from the new file
import { authOptions } from "@/lib/auth-config"; 

const handler = NextAuth(authOptions);
export { handler as GET, handler as POST, authOptions }; // Re-export just in case
// 
...
//         return { id: user.userId, name: user.name, email: user.email, plan: user.plan };
//       },
//     }),
//   ],
//   callbacks: {
...
//         token.role = user.role || "user"; // <--- ADD THIS
//       }
//       return token;
//     },
//     async session({ session, token }) {
